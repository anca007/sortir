...
final class Version20240624124351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location ADD CONSTRAINT FK_AC74095AA0631C12 FOREIGN KEY (organiser_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE location ADD CONSTRAINT FK_AC74095A5D83CC1 FOREIGN KEY (state_id) REFERENCES state (id)');
        $this->addSql('ALTER TABLE location ADD CONSTRAINT FK_AC74095A64D218E FOREIGN KEY (location_id) REFERENCES location (id)');
        $this->addSql('ALTER TABLE location ADD CONSTRAINT FK_AC74095AAF5D55E1 FOREIGN KEY (campus_id) REFERENCES campus (id)');
        $this->addSql('ALTER TABLE activity_user ADD CONSTRAINT FK_8E570DDB81C06096 FOREIGN KEY (activity_id) REFERENCES location (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location DROP FOREIGN KEY FK_AC74095AA0631C12');
        $this->addSql('ALTER TABLE location DROP FOREIGN KEY FK_AC74095A5D83CC1');
        $this->addSql('ALTER TABLE location DROP FOREIGN KEY FK_AC74095A64D218E');
        $this->addSql('ALTER TABLE location DROP FOREIGN KEY FK_AC74095AAF5D55E1');
